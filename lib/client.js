window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* 重渲染，搜索才不卡顿。
		*/
		const ModelOption = react.memo(function ModelOption({ group, model, showProvider, selected, busy, rowKey, active, onRowFocus, nameHit, t, onChoose }) {
		...
		function ModelSelect({ locked, available, directory, load, select, t }) {
			...
			const menuMaxHeight = (0, _deepseek_ai_dsh_client_ui_primitives.useAnchoredMaxHeight)(menuAbove ? menuRef : inactiveMenuRef, 420, open);
				...
				children: [
					...
					open ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							noHits && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dms-empty dms-groupsFill",
								role: "status",
								children: t("search.noMatch", { query: query.trim() })
							}),
							noModels && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dms-empty dms-groupsFill",
								role: "status",
								children: t("empty.models")
							}),
							!noHits && !noModels && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dms-groups",
								id: `${id}-groups`,
								role: "menu",
								"aria-label": t("menu.aria"),
								children: hits !== null ? hits.items.map((hit) => {
