window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function EffortSlider({ state, select, t }) {
		...
		function ModelSelect({ locked, available, directory, load, select, t }) {
			...
			const showToast = (text, failed = true) => {
			...
			const menuMaxHeight = (0, _deepseek_ai_dsh_client_ui_primitives.useAnchoredMaxHeight)(menuRef, MENU_MAX_HEIGHT, open);
