window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		const ModelOption = react.memo(function ModelOption({ group, model, showProvider, selected, busy, rowKey, t, onChoose }) {
					...
					open ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [hits !== null ? hits.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [hits.slice(0, MAX_VISIBLE_HITS).map((hit) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ModelOption, {
									group: hit.group,
									model: hit.model,
									showProvider: true,
									...
									t,
									onChoose: choose
								}, `${hit.group.id}\u0000${hit.model.id}`)), hits.length > MAX_VISIBLE_HITS && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dms-more",
