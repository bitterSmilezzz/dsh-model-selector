window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		* 重渲染，搜索才不卡顿。
		*/
		const ModelOption = react.memo(function ModelOption({ group, model, showProvider, selected, busy, rowKey, active, searchMode, onRowFocus, nameHit, t, onChoose }) {
...
`;
		...
		*/
		...
		/* __DMS_SRC_HASH__ = "eead5888f44285e2028692c6971ab7d6d8cfeb16272176f9c2c392186c440c04" */	}
});
